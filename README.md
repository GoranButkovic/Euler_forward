This project compares the **forward Euler method** and the **semi-implicit Euler method** for solving a differential equation describing a conservative system.

The goal is to show how one method preserves the symplectic structure, while the other one does not. 
